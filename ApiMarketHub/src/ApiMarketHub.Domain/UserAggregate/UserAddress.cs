...
public class UserAddress : BaseEntity
{
    ...
    public UserAddress(string state, string city, string postalCode, string addressDetail, 
    ...
    public void Edit(string state, string city, string postalCode, string addressDetail, 
        PhoneNumber phoneNumber, string name, string family, string nationalCode)
    {
        Guard(state, city, postalCode, addressDetail, phoneNumber, name, family, nationalCode);
        State = state;
    ...
    public void Guard(string state, string city, string postalCode, string addressDetail, 
        PhoneNumber phoneNumber, string name, string family, string nationalCode)
    {
        if (phoneNumber == null)
